...
public class DipendenteView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DipendenteView p = new DipendenteView();
					p.pack();
					p.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
	...
	public DipendenteView() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DipendenteView.class.getResource("/resources/IconaLogin.png")));
        setTitle("Bidons");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        // Utilizza pack() invece di setBounds() per adattare la finestra ai componenti.
